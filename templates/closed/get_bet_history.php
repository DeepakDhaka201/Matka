<?php
$dummy_data = [
    ['user' => '9876543210','name' => 'Rajesh Sharma', 'number' => 12, 'amount' => 100, 'game' => 'jodi', 'bazar' => 'gali', 'is_loss' => 0, 'status' => 1, 'created_at' => time()],
    ['user' => '8765432109','name' => 'Neha Patel', 'number' => 9, 'amount' => 200, 'game' => 'single', 'bazar' => 'disawar', 'is_loss' => 0, 'status' => 0, 'created_at' => time()],
    ['user' => '7654321098','name' => 'Sanjay Singh', 'number' => 18, 'amount' => 150, 'game' => 'jodi', 'bazar' => 'faridabad', 'is_loss' => 0, 'status' => 1, 'created_at' => time()],
    ['user' => '6543210987','name' => 'Pooja Mehta', 'number' => 27, 'amount' => 300, 'game' => 'single', 'bazar' => 'ghaziabad', 'is_loss' => 1, 'status' => 0, 'created_at' => time()],
    ['user' => '5432109876','name' => 'Manish Gupta', 'number' => 6, 'amount' => 250, 'game' => 'jodi', 'bazar' => 'gali', 'is_loss' => 0, 'status' => 1, 'created_at' => time()],
    ['user' => '4321098765','name' => 'Ritu Jain', 'number' => 15, 'amount' => 180, 'game' => 'single', 'bazar' => 'disawar', 'is_loss' => 0, 'status' => 1, 'created_at' => time()],
    ['user' => '3210987654','name' => 'Amit Verma', 'number' => 20, 'amount' => 220, 'game' => 'jodi', 'bazar' => 'ghaziabad', 'is_loss' => 1, 'status' => 1, 'created_at' => time()]
];
                                    ...
                                    <table id="order-listing" class="table">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php if($bl['is_loss']=="1"){ echo "<span style='color:red'>Loss</span>"; }else if($bl['status']=="1"){echo "<span style='color:green'>Win</span>";} else {  echo  "<span style='color:black'>Pending</span>"; } ?></td>
                                        ...
                                        <?php $i; while ($bl = fetch($dummy_data)) { 
                                        $allam = $bl['amount'];
                                        ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                ...
                                                <td><?php echo $bl['amount']; ?></td>
                                                <td><?php echo $bl['game']; ?></td>
                                                <td><?php echo "Card ".str_replace("_"," ",$bl['timing']); ?></td>
                                                <td><?php if($bl['is_loss']=="1"){ echo "<span style='color:red'>Loss</span>"; }else if($bl['status']=="1"){echo "<span style='color:green'>Win</span>";} else {  echo  "<span style='color:black'>Pending</span>"; } ?></td>
                                                <td><?php echo date("d/m/Y h:i A",$bl['created_at']); ?></td>
