...
$blog = query("select * from manual_batch where type='2' order by sn desc");
                                            ...
                                            <tr>
                                                ...
                                                <td><?php out(date('d/m/y h:i A',$bl['created_at'])); ?></td>
                                                 ...
                                                 <td>
                                                    ...
                                                    <?php } else { ?>
                                                       <a onclick="return confirm('Are you sure you want to revert this back ?')" href="delhi_batch_history.php?revert=<?php echo $bl['batch_id']; ?>"> <button class="btn btn-outline-warning">Revert Back</button> </a>
                                                    <?php } ?>
