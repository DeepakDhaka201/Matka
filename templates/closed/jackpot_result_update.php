...
if (isset($_REQUEST['submit']))
{
    ...
    if(strlen($open) != 1){
        ...
        $error = "Open must be 1 digit";
        
    } else {
        
        query("INSERT INTO `jackpot_results`( `market`, `timing`, `number`, `date`, `created_at`) VALUES ('$market','$timing','$open','$date','$stamp')");
        
        $xvm = query("select * from jackpot_rate where sn='1'");
        $xv = fetch($xvm);
        ...
        $get_games = query("SELECT * FROM `jackpot_games` where bazar='$market' AND timing_sn='$timing' AND date='$date' AND number='$open'");
        ...
        while($x = fetch($get_games))
        {
            ...
            query("update jackpot_games set status='1' where sn='$sn'");
        ...
        query("update jackpot_games set is_loss='1'");
            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    ...
                    <?php while($mrk = fetch($market)){
                        ...
                        $get_timings = query("select * from jackpot_timings where market='$mrk_name'");
