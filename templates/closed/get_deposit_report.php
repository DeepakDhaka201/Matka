...
$dummy_data = [
    ['sn' => 1, 'user' => '9876543210', 'name' => 'Rajesh Kumar', 'amount' => 500, 'type' => 'Deduct', 'remark' => 'Payment for service', 'owner' => 'User', 'created_at' => time()],
    ['sn' => 2, 'user' => '8765432109', 'name' => 'Amit Patel', 'amount' => 1000, 'type' => 'Added', 'remark' => 'Referral bonus', 'owner' => 'Admin', 'created_at' => time()],
    ['sn' => 3, 'user' => '7654321098', 'name' => 'Sneha Sharma', 'amount' => 200, 'type' => 'Added', 'remark' => 'Deposit', 'owner' => 'Admin', 'created_at' => time()],
    ['sn' => 4, 'user' => '6543210987', 'name' => 'Vivek Singh', 'amount' => 800, 'type' => 'Deduct', 'remark' => 'Purchase', 'owner' => 'User', 'created_at' => time()],
    ['sn' => 5, 'user' => '5432109876', 'name' => 'Priya Gupta', 'amount' => 300, 'type' => 'Added', 'remark' => 'Deposit', 'owner' => 'Admin', 'created_at' => time()],
    ['sn' => 6, 'user' => '4321098765', 'name' => 'Anjali Desai', 'amount' => 1500, 'type' => 'Deduct', 'remark' => 'Payment for service', 'owner' => 'User', 'created_at' => time()],
    ['sn' => 7, 'user' => '3210987654', 'name' => 'Aryan Sharma', 'amount' => 600, 'type' => 'Added', 'remark' => 'Deposit', 'owner' => 'Admin', 'created_at' => time()]
];
                                ...
                                <div class="table-responsive">
                                    <table id="order-listing" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $total = 0;
                                            $i = 1; while ($bl = fetch($dummy_data)) {
                                            
                                            if($bl['owner']=="")
                                            {
                                                $owner = "User";
                                            }
                                            else if($bl['owner'] == "Admin")
                                            {
                                                $owner = "Admin";
                                            }
                                            else
