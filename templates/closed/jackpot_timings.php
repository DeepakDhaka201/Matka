...
if(isset($_REQUEST['delete'])){
    ...
    query("delete from jackpot_timings where sn='$sn'");
}
    ...
    <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="card">
                       ...
                       <a style="position: absolute;right: 20px;margin-top: 18px;" href="jackpot_timing_add.php?sn=<?php echo $market; ?>"><button class="btn btn-primary">Add New Timing</button></a>
                       
                    <div class="card-body" style="margin-top: 25px;">
                        <h4 class="card-title">Jackpot Timings</h4>
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table id="order-listing" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $i = 1;
                                            $get = query("select * from jackpot_timings where market='$market'");
                                            while($xc = fetch($get))
                                            { ?>
